...
XRUN_UVM_FLAGS = -clean -64bit -v200x -v93 -uvm -sv $(VHD_PATHS) -f $(UVM_FILELIST) -top somador_top -access +rwc $(GUI_FLAG) -coverage u -covoverwrite +VETOR_PATH=$(PROJECT_DIR)/frontend/vetor.txt
#===================================================================================================
